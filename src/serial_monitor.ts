...
import FileIOController from "./file_io_controller";
import SerialMonitorView from "./serial_monitor_view"
...
class SerialMonitor{
    ...
    $_serialMonitorView:SerialMonitorView;
    ...
    initElements(){
        ...
        this.$_headerContainer.append($("<span>").text("Serial monitor"));
        ...
        this.$_serialDataMenuContainer.append($("<span>").text("Type"));
        this.$_serialDataMenuContainer.append(this.$_serialDataTypeMenu);
        this.$_serialDataMenuContainer.append($("<span>").text("Display type"));
        this.$_serialDataMenuContainer.append(this.$_serialDataDisplayTypeMenu);
        this.$_serialDataMenuContainer.append($("<span>").text("Baud rate"));
        ...
        this.$_connectButton = $("<button>").text("Connect");
        this.$_disConnectButton = $("<button>").text("Disconnect");
        this.$_sendDataTextArea = $("<textarea>").attr("rows", 1).attr("class", "no_scrollbars").attr("placeholder", "Enter data to send");
        this.$_sendButton = $("<button>").text("Send");
        ...
        this.$_serialMonitorView = new SerialMonitorView(this.$_logOutputContainerId)
    }
    ...
    initInteraction(){
        this.$_connectButton.on("click", async () => {
            if ("serial" in navigator){
                let connection:boolean = await this.serialConnectButtonHandler();
                if (connection ){
    ...
    serialReadBufferPrint(value:string){
        ...
        this.$_serialMonitorView.print(value);
    ...
    serialReadBufferPrintLn(){
        //this.$_currentOutputLineContainer = $("<div>");
        //this.$_logOutputContainer.prepend(this.$_currentOutputLineContainer);
        this.$_serialMonitorView.printNewLine();
        this.$_serialDataTrace.push("");
    }


    async serialConnectButtonHandler():Promise<boolean>{
